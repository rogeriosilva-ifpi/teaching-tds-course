...
while regime != 20 and regime != 40: 
    regime = int(input('ola de novo, opçao invalida, informe sua carga horaria (20 ou 40)'))

qualificacao = input('chega de ola, informe sua qualificaçao ( E para especialista, M para mestre e  D para doutor.):\n>>>').upper()

while qualificacao != 'M' and qualificacao != 'E' and qualificacao != 'D':   
    qualificacao = input('ola de novo, informe sua qualificaçao novamente ( E para especialista, M para mestre e  D para doutor.):\n>>>').upper()
